...
/* harmony import */ var _params_params_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./params/params.component */ "./src/app/params/params.component.ts");
...
const routes = [
    ...
    { path: 'params', component: _params_params_component__WEBPACK_IMPORTED_MODULE_3__["ParamsComponent"] },
];
...
/* harmony import */ var ngx_order_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-order-pipe */ "./node_modules/ngx-order-pipe/__ivy_ngcc__/fesm2015/ngx-order-pipe.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _params_params_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./params/params.component */ "./src/app/params/params.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        ...
        _params_params_component__WEBPACK_IMPORTED_MODULE_7__["ParamsComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
        ngx_order_pipe__WEBPACK_IMPORTED_MODULE_5__["OrderModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _home_home_component__WEBPACK_IMPORTED_MODULE_3__["HomeComponent"],
                    _params_params_component__WEBPACK_IMPORTED_MODULE_7__["ParamsComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
...
/* harmony import */ var _steam_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../steam.service */ "./src/app/steam.service.ts");
...
function HomeComponent_option_28_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option", 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const paya_r11 = ctx.$implicit;
...
function HomeComponent_div_34_tr_7_Template(rf, ctx) { if (rf & 1) {
...
function HomeComponent_div_34_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "Moyenne d'heure jou\u00E9es");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class HomeComponent {
    constructor(steamService, personService, fb) {
    ...
    ngOnInit() {
        ...
        call.subscribe(payas => {
            payas.forEach(paya => {
                let person = { steamid: paya.steamid, username: paya.nomPersonne };
                if (this.lesPayas.find(unPaya => unPaya.steamid != person.steamid)) {
                    this.lesPayas.push(person);
                }
            });
        });
    }
    compareGames() {
        let steamid1 = this.userSelection.controls.firstUser.value;
        let steamid2 = this.userSelection.controls.secondUser.value;
        let steamid3 = this.userSelection.controls.thirdUser.value;
        let steamid4 = this.userSelection.controls.forthUser.value;
        this.getGames(steamid1, steamid2, steamid3, steamid4);
    }
    getGames(steamid1, steamid2, steamid3, steamid4) {
        this.steamService.getGames(steamid1)
            .subscribe(result1 => {
            var games1 = result1;
            this.steamService.getGames(steamid2)
                .subscribe(result2 => {
                var games2 = result2;
                // console.log(typeof(games1));
                // console.log(typeof(games2));
                if (typeof (games1) != 'undefined' && typeof (games2) != 'undefined') {
                    this.games = this.getIntersect(games1, games2);
                    if (steamid3 != '1') {
                        this.steamService.getGames(steamid3)
                            .subscribe(result3 => {
                            var games3 = result3;
                            this.games = this.getIntersect2(games1, games2, games3);
                            if (steamid4 != '1') {
                                this.steamService.getGames(steamid4)
                                    .subscribe(result4 => {
                                    var games4 = result4;
                                    this.games = this.getIntersect3(games1, games2, games3, games4);
                                    this.getGamesInfos();
                                });
                            }
                            else {
    ...
    getGamesInfos() {
        this.games.forEach(game => {
            this.steamService.getGameInfo(game.appid).subscribe(gameInfo => {
    ...
    getIntersect3(arr1, arr2, arr3, arr4) {
        var temp = [];
        for (var i = 0; i < arr1.length; i++) {
            for (var k = 0; k < arr2.length; k++) {
                for (var l = 0; l < arr3.length; l++) {
    ...
    onSubmit() {
        ...
        if (!this.userSelection.valid) {
            ...
            this.compareGames();
            // alert(JSON.stringify(this.userSelection.value));
        }
        return false;
    }
    isMemeJoueur() {
...
HomeComponent.ɵfac = function HomeComponent_Factory(t) { return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_steam_service__WEBPACK_IMPORTED_MODULE_2__["SteamService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_person_service__WEBPACK_IMPORTED_MODULE_3__["PersonService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"])); };
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 37, vars: 16, consts: [["class", "alert alert-danger", 4, "ngIf"], [1, "form-group", "table", 3, "formGroup", "ngSubmit"], [1, "tr"], [1, "td"], ["formControlName", "firstUser", "name", "", 1, "form-control"], ["value", "1"], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "secondUser", "name", "", 1, "form-control"], ["formControlName", "thirdUser", "name", "", 1, "form-control"], ["formControlName", "forthUser", "name", "", 1, "form-control"], ["type", "submit", 1, "btn", "btn-primary"], ["class", "container", 4, "ngIf", "ngIfElse"], ["class", "container"], ["elseBlock", ""], [1, "alert", "alert-danger"], [3, "value"], [1, "container"], [1, "table", "table-striped"], [4, "ngFor", "ngForOf"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, HomeComponent_div_0_Template, 2, 1, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "form", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function HomeComponent_Template_form_ngSubmit_1_listener() { return ctx.onSubmit(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, "Deuxi\u00E8me joueur");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](20, "Troisi\u00E8me joueur");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](27, "Quatri\u00E8me joueur");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
    ...
    }], function () { return [{ type: _steam_service__WEBPACK_IMPORTED_MODULE_2__["SteamService"] }, { type: _person_service__WEBPACK_IMPORTED_MODULE_3__["PersonService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }]; }, null); })();
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _steam_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../steam.service */ "./src/app/steam.service.ts");
...
class ParamsComponent {
    constructor(steamService, personService) {
        this.steamService = steamService;
        this.personService = personService;
    }
    ngOnInit() {
        this.lesPayas = [];
        this.personService.getAllPaya().subscribe(payas => {
            payas.forEach(paya => {
                let person = { steamid: paya.steamid, username: paya.nomPersonne };
                if (!this.lesPayas.find(unPaya => unPaya.steamid == person.steamid)) {
                    this.lesPayas.push(person);
    ...
    updateGames() {
        ...
        this.lesPayas.forEach(paya => {
            console.log(paya.username);
            this.steamService.updateGamesPlayer(paya.steamid).subscribe(result => console.log('mise à jour faite pour ' + paya.username));
        });
    }
}
ParamsComponent.ɵfac = function ParamsComponent_Factory(t) { return new (t || ParamsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_steam_service__WEBPACK_IMPORTED_MODULE_1__["SteamService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_person_service__WEBPACK_IMPORTED_MODULE_2__["PersonService"])); };
ParamsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ParamsComponent, selectors: [["app-params"]], decls: 7, vars: 0, consts: [[1, "container", "row"], [1, "col"], [1, "btn", "btn-success", 3, "click"]], template: function ParamsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "span");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "Mise \u00E0 jour des jeux en fonction des informations Steam");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "button", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ParamsComponent_Template_button_click_5_listener() { return ctx.updateGames(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ParamsComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
                selector: 'app-params',
    ...
    }], function () { return [{ type: _steam_service__WEBPACK_IMPORTED_MODULE_1__["SteamService"] }, { type: _person_service__WEBPACK_IMPORTED_MODULE_2__["PersonService"] }]; }, null); })();
...
class SteamService {
    ...
    updateGamesPlayer(steamid) {
        return this.httpClient.get(this.url + '/steam/' + steamid + '/savegames', optionRequete);
    }
}
SteamService.ɵfac = function SteamService_Factory(t) { return new (t || SteamService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
SteamService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: SteamService, factory: SteamService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SteamService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
module.exports = __webpack_require__(/*! D:\website\SteamApp\frontend\src\main.ts */"./src/main.ts");
